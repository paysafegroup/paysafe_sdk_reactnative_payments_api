import { PaysafeSDK, PaysafeCardPayments, PaysafeEnvironment } from '../__mocks__/paysafe-sdk';

const MOCK_DATE = '2024-06-15';

describe('PaysafeContext Components', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    jest.useFakeTimers();
  ...
  it('processes payments through the card payments module', async () => {
  ...
  it('validates payment card information', () => {
