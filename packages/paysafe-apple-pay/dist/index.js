...
export function initializeApplePayContext(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield NativeRNPaysafeApplePay.initializeContext({
...
export function resetApplePayContext() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield NativeRNPaysafeApplePay.resetContext();
    });
}
/**
...
export function tokenize(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = (yield NativeRNPaysafeApplePay.tokenize(payload));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const nativeReq = (request === null || request === void 0 ? void 0 : request.supportedNetworks) && request.supportedNetworks.length > 0
                ...
                : {};
            const result = (yield NativeRNPaysafeApplePay.isApplePayAvailable(nativeReq));
            return {
