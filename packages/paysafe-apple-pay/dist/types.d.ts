...
export type PaysafeApplePayTransactionType = 'PAYMENT' | 'VERIFICATION' | 'STANDALONE_CREDIT' | 'ORIGINAL_CREDIT';
...
export type ApplePayNetwork = 'visa' | 'masterCard' | 'amex' | 'discover' | 'interac' | 'privateLabel';
