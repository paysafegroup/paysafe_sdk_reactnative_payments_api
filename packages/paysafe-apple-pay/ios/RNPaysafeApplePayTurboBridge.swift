//
//  RNPaysafeApplePayTurboBridge.swift
//
...
@objcMembers
@objc(RNPaysafeApplePayTurboBridge)
public class RNPaysafeApplePayTurboBridge: NSObject {
  private var applePayContext: PSApplePayContext?
  private let contextLock = NSLock()

  @objc public static let shared = RNPaysafeApplePayTurboBridge()

  @objc(resetContext:rejecter:)
  ...
  @objc(initializeContext:resolver:rejecter:)
  public func initializeContext(
  ...
  public func isApplePayAvailable(
    _ options: NSDictionary?,
    resolver: @escaping RCTPromiseResolveBlock,
    rejecter _: @escaping RCTPromiseRejectBlock
  ) {
...
internal extension RNPaysafeApplePayTurboBridge {
