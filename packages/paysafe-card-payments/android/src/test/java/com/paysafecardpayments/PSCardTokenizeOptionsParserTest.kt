...
class PSCardTokenizeOptionsParserTest {
  ...
  private fun mockIdentityDocuments(): ReadableArray {
    ...
    val arrayList = java.util.ArrayList<Any?>()
    arrayList.add(documentMap1)
    arrayList.add(documentMap2)
    whenever(identityDocumentsArray.toArrayList()).thenReturn(arrayList)
