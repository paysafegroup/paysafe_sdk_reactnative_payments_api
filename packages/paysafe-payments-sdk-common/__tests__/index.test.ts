...
describe('paysafe-payments-sdk-common', () => {
  ...
  describe('setup function', () => {
    it('should setup with TEST environment', async () => {
    ...
    it('should setup with PROD environment', async () => {
    ...
    it('should reject when native setup fails', async () => {
  ...
  describe('getNativeModule proxy behavior', () => {
    it('should use real module when available', async () => {
      ...
      await setup('test-key');

      expect(mockSetup).toHaveBeenCalledWith('test-key', 'TEST');
    });
